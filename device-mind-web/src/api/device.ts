...
export function getDeviceList(data: DevicePageQueryDTO) {
  return request.post<any, PageResult<DeviceVO>>('/device-mind/devices/list', data)
}

export function getDeviceById(id: number) {
  return request.get<any, DeviceVO>('/device-mind/devices/detail', { params: { id } })
}

export function createDevice(data: DeviceCreateDTO) {
  return request.post('/device-mind/devices', data)
}

export function updateDevice(id: number, data: DeviceUpdateDTO) {
  return request.put('/device-mind/devices', data, { params: { id } })
}

export function deleteDevice(id: number) {
  return request.delete('/device-mind/devices', { params: { id } })
}

export function updateDeviceStatus(id: number, data: DeviceStatusUpdateDTO) {
  return request.put('/device-mind/devices/status', data, { params: { id } })
}
