...
export function updateAttribute(productId: string, id: string, data: T.ThingAttributeUpdateDTO) {
  return request.put(`${BASE}/attributes`, data, { params: { productId, id } })
}
export function deleteAttribute(productId: string, id: string) {
...
export function updateService(productId: string, id: string, data: T.ThingServiceUpdateDTO) {
  return request.put(`${BASE}/services`, data, { params: { productId, id } })
}
export function deleteService(productId: string, id: string) {
...
export function updateEvent(productId: string, id: string, data: T.ThingEventUpdateDTO) {
  return request.put(`${BASE}/events`, data, { params: { productId, id } })
}
export function deleteEvent(productId: string, id: string) {
