  ...
  routes: [
    {
      ...
      children: [
        ...
        { path: '/monitor', name: 'Monitor', component: () => import('@/views/monitor/DashboardRealtimeView.vue'), meta: { title: '设备数据', icon: 'DataAnalysis' } },
        ...
        { path: '/scenes', name: 'Scenes', component: () => import('@/views/scene/SceneListView.vue'), meta: { title: '场景联动', icon: 'SwitchButton' } },
