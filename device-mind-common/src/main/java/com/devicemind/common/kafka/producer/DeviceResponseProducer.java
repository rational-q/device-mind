...
/**
 * 设备指令响应生产者 — Broker → Core（设备回执）
 */
@Slf4j
public class DeviceResponseProducer {

    private final KafkaTemplate<String, String> kafkaTemplate;
    private final String topic;

    public DeviceResponseProducer(KafkaTemplate<String, String> kafkaTemplate, String topic) {
    ...
    public void sendResponse(String deviceId, String command, String idempotencyKey, String data) {
        sendAsync(new DeviceResponseEvent(deviceId, command, idempotencyKey, data, System.currentTimeMillis() / 1000));
    }
}
